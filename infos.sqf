...
player createDiaryRecord ["tuto", ["Comment jouer", "blablabla <br /> explications <br /> blablabla"]];
//execVM tutohalo

player createDiarySubject ["dev","Development"];
player createDiaryRecord ["dev", ["Crédits"," blablabla <br /> explications <br /> blablabla"]];
player createDiaryRecord ["dev", ["Signaler un problème", " blablabla <br /> explications <br /> blablabla"]];
