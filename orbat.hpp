class CfgORBAT
{
	class DIS
	{
		...
		insignia = __EVAL(getMissionPath "utilities\dis.paa"); // Unit insignia, displayed in ORBAT background and in tooltip
		...
		// %3 - Size (e.g. "Division")
		textShort = "D. I. S.";
		texture = __EVAL(getMissionPath "utilities\dis.paa"); // Custom texture, will replace icon set by 'type' param.
