...
{
	[locationPosition _x, 1000, {2 + (count (allPlayers - entities "HeadlessClient_F"))/5;}, heavy_vls, true] execVM "spawnVh.sqf";
	[locationPosition _x, 1000, {3 + (count (allPlayers - entities "HeadlessClient_F"))/5;}, light_vls, true] execVM "spawnVh.sqf";
...
{
	[locationPosition _x, 500, {(count (allPlayers - entities "HeadlessClient_F"))/6;}, heavy_vls, true] execVM "spawnVh.sqf";
	[locationPosition _x, 500, {2 + (count (allPlayers - entities "HeadlessClient_F"))/5;}, light_vls, true] execVM "spawnVh.sqf";
...
{
	[locationPosition _x, 300, {1 + (count (allPlayers - entities "HeadlessClient_F"))/6;}, light_vls, true] execVM "spawnVh.sqf";
